...
export function drawIcon(c, type, col, time) {
  ...
  switch (type) {
    case "fire":
      c.beginPath();
      c.moveTo(0, -s);
      c.quadraticCurveTo(s * 0.9, -s * 0.2, s * 0.4, s * 0.7);
      c.quadraticCurveTo(0, s * 0.3, -s * 0.4, s * 0.7);
      ...
      c.beginPath();
      c.moveTo(0, -s * 0.2);
      c.quadraticCurveTo(s * 0.35, s * 0.3, 0, s * 0.55);
      c.quadraticCurveTo(-s * 0.35, s * 0.3, 0, -s * 0.2);
      c.fill();
      break;
    case "bomb":
      c.beginPath();
      c.arc(0, s * 0.15, s * 0.72, 0, 7);
      c.fill();
      st();
      c.beginPath();
      ...
      c.fillStyle = "#ffd447";
      c.beginPath();
      c.arc(s * 0.55, -s * 0.95, s * 0.16, 0, 7);
      c.fill();
      break;
    case "speed":
      c.fillStyle = "#3db4ff";
      rr(c, -s * 0.5, -s * 0.3, s * 0.9, s * 0.7, 4);
      c.fill();
      st();
      c.fillStyle = "#cfe6ff";
      c.beginPath();
      ...
      c.lineTo(-s * 1.15, s * 0.05);
      c.lineTo(-s * 0.5, s * 0.25);
      c.fill();
      c.fillStyle = "#0d3f78";
      c.beginPath();
      c.arc(-s * 0.2, s * 0.4, s * 0.16, 0, 7);
      c.arc(s * 0.3, s * 0.4, s * 0.16, 0, 7);
      c.fill();
      break;
    case "heart":
      c.beginPath();
      c.moveTo(0, s * 0.6);
      c.bezierCurveTo(-s, -s * 0.2, -s * 0.3, -s * 0.9, 0, -s * 0.25);
      c.bezierCurveTo(s * 0.3, -s * 0.9, s, -s * 0.2, 0, s * 0.6);
      c.fill();
      st();
      c.fillStyle = "rgba(255,255,255,0.5)";
      c.beginPath();
      c.arc(-s * 0.25, -s * 0.15, s * 0.14, 0, 7);
      c.fill();
      break;
    case "shield":
      c.beginPath();
    ...
    case "kick":
      c.fillStyle = "#c07a3a";
      rr(c, -s * 0.15, -s * 0.2, s * 0.5, s * 0.6, 3);
      c.fill();
      st();
      c.fillStyle = "#8a5326";
      rr(c, -s * 0.6, s * 0.3, s * 0.9, s * 0.28, 3);
      c.fill();
      st();
    ...
    case "throw":
      ...
      c.moveTo(-s * 0.7, 0);
      c.lineTo(s * 0.7, 0);
      c.lineTo(s * 0.7, -s * 0.25);
      c.lineTo(s * 0.35, -s * 0.25);
    ...
    case "pass":
      ...
      c.lineCap = "round";
      c.beginPath();
      c.arc(0, 0, s * 0.6, 0.4, Math.PI - 0.4);
      c.stroke();
      c.beginPath();
      c.moveTo(0, -s * 0.8);
      c.lineTo(0, s * 0.7);
    ...
    case "power":
      ...
      c.fillStyle = "#fff";
      c.beginPath();
      c.arc(-s * 0.15, -s * 0.15, s * 0.14, 0, 7);
      c.fill();
      break;
    case "pierce":
      c.fillStyle = "#12203a";
      ...
      c.lineWidth = 2;
      for (let i = 0; i < 4; i++) {
        const a = (i / 4) * 6.283 + (time || 0);
        c.beginPath();
        c.moveTo(Math.cos(a) * s * 0.6, Math.sin(a) * s * 0.6);
        c.lineTo(Math.cos(a) * s * 1.1, Math.sin(a) * s * 1.1);
        c.stroke();
      }
      c.fillStyle = col;
      c.beginPath();
      c.arc(0, 0, s * 0.24, 0, 7);
      c.fill();
      break;
    case "remote":
      c.fillStyle = "#3a4256";
      rr(c, -s * 0.7, -s * 0.5, s * 1.4, s * 1.0, 4);
      c.fill();
      st();
      c.fillStyle = "#0d1018";
      rr(c, -s * 0.45, -s * 0.25, s * 0.9, s * 0.45, 3);
      c.fill();
      c.fillStyle = "#37f0d0";
      rr(c, -s * 0.35, -s * 0.15, s * 0.7, s * 0.2, 1);
      c.fill();
      c.strokeStyle = "#9aa3c0";
      c.lineWidth = 1.5;
      c.beginPath();
      c.moveTo(0, -s * 0.5);
      c.lineTo(0, -s * 0.9);
