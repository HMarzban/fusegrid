...
export function drawLogo(c, time){
  c.save();
  c.textAlign="center"; c.textBaseline="middle";
  const x=CFG.COLS*CFG.TILE/2, y=CFG.ROWS*CFG.TILE/2-34;
...
export function drawOverlay(c, world){
  ...
  const cx=CFG.COLS*CFG.TILE/2, cy=CFG.ROWS*CFG.TILE/2;
