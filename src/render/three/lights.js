...
export function createLights(biome){
  const hemi=new THREE.HemisphereLight(biome.sky||"#cfe8ff",biome.bg1,0.55);
  const dir=new THREE.DirectionalLight("#fff4e2",1.05);
  ...
  const fill=new THREE.DirectionalLight("#bcd4ff",0.45);
