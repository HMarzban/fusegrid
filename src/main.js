...
import { clampHeat, heatToken } from "./core/heat.js";
  ...
  if (
    ...
    window.__GAME__ = {
      ...
      step: (n = 1) => {
        ...
        renderer.render(world, CFG.STEP * n);
      },
      state: () =>
