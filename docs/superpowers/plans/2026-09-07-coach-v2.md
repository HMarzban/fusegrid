...
- **`main.js`'s line pin rises to 808 exactly once**, in **Task 3** — this plan's
  only `main.js`-touching task. Additions total **+11** over R8's 798. The
...
```js
  ...
  // and coach_dismissed emits; ro.coach2) — bumped 798->808. The v2 transition
...
If your `main.js` measures above 808, move more of the transition into
